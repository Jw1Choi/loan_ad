$(document).ready(function(){
    ...
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSc-HIMa3YwShAPOko6JBnIPJfAzEp3h-RQUlnaIf3IKkOhKxA/formResponse");
...
function maxLengthCheck(object){
 ...
 function hoa(){
    setTimeout( function(){
        alert("신청이 완료되었습니다. 빠르게 안내드리겠습니다.");
        $(window).scrollTop(0);
